...
const questions = [
  {
    ...
    answer: `We will deliver your card by courier free of charge. Delivery in Moscow and St. Petersburg - 1-2 working days. 
  ...
  },
  {
    ...
    answer: `A credit card with a grace period is a bank card with an established credit limit, designed for payment,
  ...
  },
  {
    ...
    answer: `You can activate your credit card and generate a PIN code immediately
    after receiving the card at a bank branch using a PIN pad.`,
  },
  {
    question: 'What is a settlement date?',
    answer: `The settlement date is the date from which you can pay off the debt for the reporting period.
  ...
  },
  {
    ...
    answer: ` For each reporting period from the 7th day of the previous month to the 6th day of the current month inclusive,
  ...
  return (
    <div className="wrapper information-section__faq">
      ...
      <div className="information-section__questions">
        {
          questions.slice(0, 5).map((item, id) => {
